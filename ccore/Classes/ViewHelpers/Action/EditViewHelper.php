 ...
 */
class Tx_Ccore_ViewHelpers_Action_EditViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	public function render($tablename, $uid) {
		$params = '&edit['.$tablename.']['.intval($uid).']=edit';
		$js = t3lib_BEfunc::editOnClick($params,$this->doc->backPath);
		
		// localization
		$label = Tx_Extbase_Utility_Localization::translate(
			'LLL:EXT:ccore/Resources/Private/Language/locallang.xml:' .$tablename. '.edit_label',
			'Ccore'
		);
