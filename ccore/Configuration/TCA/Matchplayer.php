...
$TCA['tx_ccore_domain_model_matchplayer'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, languagetag, enemy, feuser, matchid',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, languagetag, enemy, feuser, matchid,--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_ccore_domain_model_matchplayer.pid=###CURRENT_PID### AND tx_ccore_domain_model_matchplayer.sys_language_uid IN (-1,0)',
			),
		),
