...
$TCA['tx_ccore_domain_model_matchresult'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, round, resultpro, resultcon, matchid, mapid',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, round, resultpro, resultcon, matchid, mapid,--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_ccore_domain_model_matchresult.pid=###CURRENT_PID### AND tx_ccore_domain_model_matchresult.sys_language_uid IN (-1,0)',
			),
		),
		...
		'round' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:ccore/Resources/Private/Language/locallang_db.xml:tx_ccore_domain_model_matchresult.round',
			'config' => array(
				'type' => 'input',
				'size' => 4,
				'eval' => 'int,required'
